...
We can observe that the mean $\boldsymbol{\mu}_q(\rvx_t,\rvx_0)$ is a linear combination of $\rvx_t$ and $\rvx_0$. Geometrically, it lives on the straight line connecting $\rvx_t$ and $\rvx_0$.
