...
Boosting builds a strong model by adding many small, simple models (weak learners) sequentially. \textbf{Each new model focuses on the mistakes of the models before it}. In the end, we add their predictions to get one strong predictor.
