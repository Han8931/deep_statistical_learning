...
\footnotetext{Cauchy-Schwarz Inequaility: $|\mathbf{a}\cdot \mathbf{b}|\leq ||\mathbf{a}||\textrm{ } ||\mathbf{b}||$. Equality holds if and only if either $\mathbf{a}$ or $\mathbf{b}$ is a multiple of the other.}
